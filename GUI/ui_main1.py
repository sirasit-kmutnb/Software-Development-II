...
"padding-right: 20px;")
        ...
        self.EmptyFrame = QtWidgets.QFrame(parent=self.frame_9)
        self.EmptyFrame.setMinimumSize(QtCore.QSize(0, 0))
        self.EmptyFrame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.EmptyFrame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.EmptyFrame.setObjectName("EmptyFrame")
        self.verticalLayout_16.addWidget(self.EmptyFrame)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 657, 2237))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Start Time, End Time : year.month.day.hour.minute.second, For Ex 2023,1,31,14,59,21"))
