...
class TestFindTweets(unittest.TestCase):
    ...
    def test_FindbyTime(self):
        ...
        result = self.Puller.find_multi(fromtime="2023.1.1.0.0.0",totime="2023.1.2.0.0.0")
    ...
    def test_FindbyMultiCriteria(self):
        ...
        result = self.Puller.find_multi(author="anonymusk",keyword="dummy",text="Donec")
        self.assertEqual(result,[self.dummy_tweets[2]])

        #find tweets by All Criteria
        result = self.Puller.find_multi(author="anonymud",hashtag="#dummy",keyword="dummy",text="vel",fromtime="2022.1.1.19.10.0",totime="2023.1.1.0.0.0")
        self.assertEqual(result,[self.dummy_tweets[3]])
